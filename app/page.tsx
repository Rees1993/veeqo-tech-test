...
export default function Home() {
  return (
    <main className="grow">
      {/* Hero */}
      <section className="px-4 my-12 flex flex-col items-center text-center mx-auto">
        <svg
        ...
        >
          ...
          <path
            ...
            stroke="#05192D"
            strokeWidth=".455"
            d="m87.341 47.693 7.384 27.556c1.562 5.829-1.901 11.826-7.73 13.388l-27.556 7.384c-5.829 1.561-11.826-1.901-13.388-7.73l-7.384-27.556c-1.562-5.829 1.901-11.827 7.73-13.388l27.556-7.384c5.829-1.562 11.826 1.9 13.388 7.73Z"
          />
          <path
            fill="#fff"
            d="m84.59 74.488-6.11-22.8a2.877 2.877 0 0 0-3.525-2.035l-22.8 6.11c-1.684.45-1.97 2.696-.462 3.546l30.085 17.37c1.46.864 3.255-.532 2.811-2.19Z"
          />
          <circle
            cx={55}
            cy={55}
        ...
        <h1 className="text-[4.375rem] font-semibold max-w-3xl leading-[82px] tracking-[-1%] mt-8">
          Own your <span className="text-[#2578FF]">future</span> simple and for{" "}
          <span className="text-[#2578FF]">free</span>
        </h1>
        <div className="grid justify-items-center mt-24 relative">
          <div className="bg-[#070F17]/20 absolute inset-0" />
          <Image
            className="rounded-3xl row-start-1 col-start-1"
            src={mainHero}
            alt="Team Photo"
          />
          <div className="row-start-1 col-start-1 self-center w-28 h-28 rounded-full flex items-center justify-center isolate cursor-pointer bg-white">
            <svg
              width="59"
              height="59"
              viewBox="0 0 59 59"
      ...
      {/* Who we are */}
      <section className="mt-48 px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-2 gap-6 items-start">
          <Badge
            variant="blue"
            className="shrink-0 text-lg justify-self-center"
          >
            Who we are
          </Badge>
          <div className="text-[2rem] leading-[2.875rem] font-medium">
            ...
            <p className="[&:not(:first-child)]:mt-6">
              As part of the Amazon family,{" "}
              <span className="text=[#2578FF]">Veeqo</span> provides trusted
              data security and Amazon account protection from late deliveries
              and negative feedback, if you ship on time.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Image Grid */}
      <section className="overflow-hidden mt-60 pb-2 justify-center max-w-none flex gap-9 items-end">
        <Image src={imageGrid1} className="pb-8" alt="" />
        <Image src={imageGrid2} className="self-start" alt="" />
        <Image src={imageGrid3} className="pb-8" alt="" />
        <Image src={imageGrid4} alt="" />
      </section>

      {/* Start saving */}
      <section className="bg-white py-36 px-4 text-[#05192D]">
        <div className="max-w-7xl mx-auto grid grid-cols-2 gap-20 items-center">
          <div className="max-w-md">
            <Badge>Start saving today</Badge>
            <h2 className="text-5xl leading-[56px] tracking-[-1%] mt-10 font-semibold">
              See how much you could save
            </h2>
            <p className="mt-10 text-lg font-medium">
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Aenean vulputate semper sem nec
              sodales. Vestibulum vitae vulputate metus.
            </p>
      ...
      <section className="px-4 py-36 max-w-[96rem] mx-auto">
        <div className="grid grid-cols-2 gap-12">
          <div className="flex flex-col pt-64">
            <Badge className="self-start" variant="light">
              We're a team of
            </Badge>
            <h2 className="font-semibold mt-20 text-[12.5rem] leading-[11rem] tracking-[-3%]">
              1,000 People
            </h2>
          </div>
          <div className="grid grid-cols-2 gap-6 pl-16 justify-center content-start justify-items-center">
            <Image
              className="col-span-2 justify-self-center w-56 h-56"
              src={teamPhoto2}
              alt=""
            />
            <Image src={teamPhoto1} alt="" />
            <Image className="w-44 h-44" src={teamPhoto3} alt="" />
          </div>
        </div>
        <div className="flex mt-32">
          <div className="basis-5/12"></div>
          <ul className="basis-full grid grid-cols-2 gap-32 max-w-2xl">
            <li className="flex flex-col gap-6">
              <div className="h-20 w-20 bg-[#2578FF] rounded-full flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="53"
                  height="54"
                ...
                >
                  ...
                  >
                    <path
                      fill="#D9D9D9"
                      d="M.1 42.512L11.258.87 52.9 12.028 41.742 53.67z"
                    ></path>
                  </mask>
                  <g mask="url(#a)">
                    <path
              ...
              <p className="text-white/50 text-opacity-60 text-3xl">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 gap-20 items-center">
          ...
          <div className="max-w-md">
            ...
            <div className="mt-10 text-lg font-medium ">
              <p className="[&:not(:first-child)]:mt-6">
                Pellentesque sollicitudin ligula pharetra ipsum tristique, sit
                amet gravida leo ornare.
              </p>
              <p className="[&:not(:first-child)]:mt-6">
                Aenean nec nulla quis ligula venenatis varius. Nunc sapien
                lacus, feugiat nec consectetur a, facilisis et leo. Sed vel.
              </p>
            </div>
            <Button className="mt-10" size="lg">
              Start Shipping
